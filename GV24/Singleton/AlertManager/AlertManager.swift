...
class AlertStandard {
   static var sharedInstance = AlertStandard()
    ...
    func showAlertCt(controller: UIViewController, title: String, message: String, buttonTitle:String = "OK",completion:@escaping()->()) {
        let alertController = UIAlertController(title: title, message: message, preferredStyle: .alert)
    ...
    func showAlertCt(controller: UIViewController,pushVC:UIViewController?, title: String, message: String, buttonTitle:String = "OK", completion:@escaping (()->())) {
        let alertController = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let yesAction = UIAlertAction(title: "AnswerYes".localize, style: .default) { (action) -> Void in
